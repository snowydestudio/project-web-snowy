...
<body class="text-gray-900 bg-white font-sans antialiased overflow-x-hidden">
    ...
    <!-- 1. Hero Section -->
    <section class="w-full min-h-screen flex flex-col justify-center items-center pt-28 pb-12 px-6 md:px-16 max-w-4xl mx-auto text-center animate-on-scroll">
    ...
    <!-- 2. Studi Kasus Pilihan -->
    <section id="studi-kasus-section" class="w-full min-h-screen flex flex-col justify-center py-16 px-6 md:px-16 max-w-7xl mx-auto">
        ...
        <div id="studi-kasus-wrapper">
            ...
            <!-- Scroll Navigation Buttons (Bottom Right Below Images) -->
            <div class="flex justify-end items-center gap-3 mt-4">
                <button id="studi-kasus-prev" aria-label="Sebelumnya" class="w-11 h-11 rounded-full bg-white border border-gray-200 text-gray-700 hover:bg-primary hover:text-white hover:border-primary flex items-center justify-center shadow-sm transition-all active:scale-95 cursor-pointer">
                    <i class="fas fa-chevron-left text-sm"></i>
                </button>
                <button id="studi-kasus-next" aria-label="Selanjutnya" class="w-11 h-11 rounded-full bg-white border border-gray-200 text-gray-700 hover:bg-primary hover:text-white hover:border-primary flex items-center justify-center shadow-sm transition-all active:scale-95 cursor-pointer">
    ...
    <!-- 3. Tim di Balik Proyek Ini -->
    <section class="w-full min-h-screen flex flex-col justify-center py-16 px-6 md:px-16 max-w-7xl mx-auto">
        ...
        <div class="flex flex-col gap-8">
            ...
            <div class="flex items-center gap-6 animate-on-scroll delay-200">
                ...
                <div>
                    ...
                    <p class="text-gray-500 mt-1">Merancang antarmuka dan pengalaman pengguna.</p>
                </div>
            </div>
            <!-- Member 3 -->
            <div class="flex items-center gap-6 animate-on-scroll delay-300">
                ...
                <div>
                    <h4 class="text-xl font-bold">Front-End Developer</h4>
                    <p class="text-gray-500 mt-1">Eksekusi kode front-end.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="w-full min-h-screen flex flex-col justify-center py-16 px-6 md:px-16 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="h-80 rounded-2xl overflow-hidden animate-on-scroll delay-100">
                <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=600&auto=format&fit=crop" alt="Dokumentasi 1" class="w-full h-full object-cover">
            </div>
            <div class="h-80 rounded-2xl overflow-hidden animate-on-scroll delay-200">
                <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?q=80&w=600&auto=format&fit=crop" alt="Dokumentasi 2" class="w-full h-full object-cover">
            </div>
            <div class="h-80 rounded-2xl overflow-hidden animate-on-scroll delay-300">
                <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=600&auto=format&fit=crop" alt="Dokumentasi 3" class="w-full h-full object-cover">
            </div>
        </div>
    </section>
